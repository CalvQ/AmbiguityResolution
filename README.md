...
Ensure there are ``ambiguity_data.json`` and ``ScanRefer_filtered.json`` under the data file.

Edit the parameters at the begining of the ``human-response-agent.py``:
