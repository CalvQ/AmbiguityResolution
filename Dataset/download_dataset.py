...
if __name__ == '__main__':
    ...
    parser.add_argument('--download_path', default='./', help="Directory to store downloaded data.")
    parser.add_argument('--subset', default='Scannet', required=False, type=str, help="One of Matterport/Scannet/HM3D/Unity/ARKitScenes/3RScan.")
